...
- `server_modular.py` - Main Flask API server runtime
...
- `extensions/core/teletext/api_server.py` → Consolidated into server_modular.py
- `extensions/core/markdown/server.py` → Merged into server_modular.py
